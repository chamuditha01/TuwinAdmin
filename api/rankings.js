  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      await sheets.spreadsheets.values.append({
        ...
        // RAW stores the date exactly as given (plain text) instead of
        // letting Sheets auto-parse it, which round-trips through the
        // spreadsheet's locale and can shift it by a day.
